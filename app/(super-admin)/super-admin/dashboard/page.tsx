...
import { IterationCcw, Share2 } from "lucide-react";
        ...
        <div className="">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <select className="rounded-lg border border-[#E5E7EB] px-3 py-2 text-sm text-[#151513] outline-none">
                        <option>Last 7 days</option>
                        <option>Last 30 days</option>
                        <option>Last 90 days</option>
                    </select>

                    <button className="flex items-center gap-2 rounded-lg border border-[#E5E7EB] px-4 py-2 text-sm text-[#151513] transition hover:bg-gray-50">
                        <span>Share</span>
                        <Share2 size={18} />
                    </button>

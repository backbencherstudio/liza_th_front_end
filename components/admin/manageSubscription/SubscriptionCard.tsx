...
function PricingCard({ plan }: PricingCardProps) {
    ...
    return (
        <div className="flex flex-col items-start gap-4 flex-1 w-full max-w-[380px] border 
        ...
        <div className="w-full py-12 px-6 bg-white">
            <div className="">
                ...
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-semibold text-[#0A206D] mb-3">Active Plan</h2>
                    <p className="text-[#3D3D3C] text-lg">Choose the plan that best fits your needs</p>
                </div>

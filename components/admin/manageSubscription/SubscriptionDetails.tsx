...
import { getSubscriptionDetails, RecentSubscriptionType } from "@/components/admin/manageSubscription/ManageSubscription";
...
export default function SubscriptionDetails({ subscription, onClose }: PlanDetailsProps) {

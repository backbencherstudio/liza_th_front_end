...
const TwoStarIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clip0_5583_8909)">
      <mask
        id="mask0_5583_8909"
        style={{
          maskType: "luminance",

    ...
    return (
        <section className="py-25">
            <div className="container mx-auto">
                ...
                {/* Heading */}
                <div className="mt-4 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between pb-14  ">
                    <h2 className="max-w-[650px] md:text-5xl text-3xl font-semibold  leading-tight text-[#151513]">
                ...
                <div className="mt-16 flex flex-col-reverse items-center gap-16 rounded-[32px]  bg-white p-10 lg:flex-row">
                    ...
                    <div className="flex flex-1 justify-center">
                        <Image
                            src="/assets/features/dashboard.png"
                            alt="Dashboard"
                            width={650}
                            height={500}
                ...
                <div className="mt- flex flex-col-reverse items-center gap-16 rounded-[32px]  bg-white pt-6 lg:flex-row">
                    {/* Left */}

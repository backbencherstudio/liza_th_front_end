      ...
      <div className="max-w-[800px] mx-auto flex flex-col items-center">
        ...
        <div className="relative w-full flex items-center justify-center mb-6 md:mb-[42px]">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button className="relative flex h-14 items-center justify-center px-8 rounded-xl border border-[#0A206D] bg-white text-[#0A206D] font-semibold text-lg transition-colors hover:bg-[#f0f4ff] cursor-pointer whitespace-nowrap overflow-hidden">
              <span className="bg-gradient-to-br from-[#0A206D] to-[#3B69D0] bg-clip-text text-transparent z-10">
                Get Started
              </span>
              <div

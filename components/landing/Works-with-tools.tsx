    ...
    return (
        ...
        >
            <div className="py-8 lg:py-12">
                <h3 className="text-[#151513] font-semibold text-center text-3xl lg:text-[40px]">
                    Works with the tools you already use
                </h3>

                <p className="text-[#3D3D3C] font-normal text-center text-xl lg:text-[20px] pt-4">
            ...
            <Marquee speed={50}>
                <div className="flex items-center gap-[66px]">
                    <Image src="/assets/worksWithTools/quickbook.png" alt="" width={200} height={100} className="w-[255px] h-[80px] lg:h-[156px]" />

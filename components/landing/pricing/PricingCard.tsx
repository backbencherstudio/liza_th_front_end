...
export default function PricingCard({ plan, billingPeriod }: CardProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-4 flex-1 w-full max-w-[380px] border [background:linear-gradient(180deg,rgba(14,105,249,0.10)_0%,rgba(0,147,255,0.00)_38.44%)] backdrop-blur-[20px] px-4 py-5 rounded-[20px] border-solid border-[#EDEDED]">

        ...
        <div className="flex-1 min-w-[200px]">
          {title ? (
            ...
            <div className="relative">
              ...
              /> */}
              <input placeholder='Search by name or email...' className='flex flex-col items-center gap-3 flex-[1_0_0] rounded border border-[color:var(--Opacity-Dark-05,rgba(8,14,30,0.05))] [background:rgba(8,14,30,0.02)] backdrop-blur-[2px] p-4 border-solid pl-10 max-w-[524px] w-full focus:outline-none' >
              </input>

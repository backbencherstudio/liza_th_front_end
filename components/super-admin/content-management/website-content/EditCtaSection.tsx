...
const ctaSectionSchema = z.object({
    ...
    ctaButtonText1: z.string().min(1, "CTA Button Text 1 is required"),
...
export default function EditBrandSection() {
    ...
    const onSubmit = async (data: CtaSectionFormValues) => {
        setSubmitError("");
        ...
        try {
            ...
            console.log("Cta section values updated:", data);
            ...
            <section className="flex w-full flex-col gap-5 rounded-[20px] border border-solid border-[#E9E9EA] bg-white p-5 shadow-[0_4px_12px_0_rgba(0,0,0,0.07)]">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <FormField
                        ...
                        placeholder="Enter CTA Button Text 1"
                        error={errors.ctaButtonText1}
                        {...register("ctaButtonText1")}
                    />

                    <FormField
                        variant="cms"
                        label="CTA Button Text 2"
                        placeholder="Enter CTA Button Text 2"
                        error={errors.ctaButtonText2}
                        {...register("ctaButtonText2")}
                    />

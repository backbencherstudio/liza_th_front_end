...
import { MonthlyData, CATEGORY_COLORS } from "./TableDataDepartment";

interface TrendBarChartProps {
    data: MonthlyData[];
}

const OperationMonthyTrendChart: React.FC<TrendBarChartProps> = ({ data }) => {
    return (
...
export default OperationMonthyTrendChart;
...
import { MonthlyData, CATEGORY_COLORS, CATEGORY_LABELS } from "./TableDataVendor";
...
const VendorCatergoryTable: React.FC<CategoryTableProps> = ({ data }) => {
    return (
...
export default VendorCatergoryTable;
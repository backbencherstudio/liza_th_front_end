                ...
                <div className="flex  items-start gap-4">
                    ...
                    <div>
                        <div className='flex flex-col md:flex-row items-center gap-2'>
                            ...
                            <div className="text-center text-[18px] font-medium leading-6 text-[#D9414D]">
                                Free Trial - 3 days left
                            </div>
                        </div>
                        <p className="font-archivo text-[20px] leading-[28px] font-medium sm:text-[22px] sm:leading-[30px] md:text-[24px] md:leading-[32px] lg:text-[26px] lg:leading-[34px] text-[#0A206D] mt-2">14-day free trial</p>
                        <p className="text-[#3D3D3C] font-archivo text-sm leading-5 font-normal md:text-base md:leading-[22px] mt-1">Renews on April 15, 2026</p>
                    </div>
                </div>
                <div>
